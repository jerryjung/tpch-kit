...
$runing_path -u $connection_address -n "hadoop" -p "" -f $tpch_kit_path"/template/create_orc_table_template"
$runing_path -u $connection_address -n "hadoop" -p "" -f $tpch_kit_path"/template/insert_orc_table_template"
