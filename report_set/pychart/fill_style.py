...
dodgerblue2 = __intern_color(Plain(bgcolor=color.dodgerblue2))
lightskyblue2 = __intern_color(Plain(bgcolor=color.lightskyblue2))
darkorange1 = __intern_color(Plain(bgcolor=color.darkorange1))
burlywood1 = __intern_color(Plain(bgcolor=color.burlywood1))
seagreen3 = __intern_color(Plain(bgcolor=color.seagreen3))
darkseagreen1 = __intern_color(Plain(bgcolor=color.darkseagreen1))
blue = __intern_color(Plain(bgcolor=color.blue))
